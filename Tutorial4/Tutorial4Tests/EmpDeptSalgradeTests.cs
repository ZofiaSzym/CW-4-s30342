...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps.Where(e =>e.DeptNo==(depts.Where(d => d.DName == "Chicago").Select(d=>d.DeptNo).FirstOrDefault())).ToList(); ; 
    ...
    public void ShouldJoinEmployeesWithDepartments()
    {
        ...
        var result = (from e in emps join d in depts on e.DeptNo equals d.DeptNo
        ...
        var emps = Database.GetEmps();
         ...
         var result = (from e in emps 
             group e by e.DeptNo into dept
                 select new {DeptNo = dept.Key, Count = dept.Count()}).ToList(); 
  ...
  var result = (from e in emps
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps.GroupBy(d => d.DeptNo).Select(e => new
        {
            DeptNo = e.Key,
        ...
        var emps = Database.GetEmps();
         ...
         var result = emps
             .Where(e => e.Sal > (emps
                 ...
                 .ToList()).FirstOrDefault(d => d.DeptNo == e.DeptNo)?.AvgSal)
             .Select(e => e.EName)
             .ToList();; 
        //
